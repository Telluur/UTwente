...
public class PasswordTest {
	...
	public static void main(String[] args){
		PasswordTest obj1 = new PasswordTest();
		obj1.runTest();
	}
	...
	/**
	 * Test the method <tt>acceptable(suggestion)</tt> This method should be
	...
	/**
	 * Test the method <tt>testWord</tt> This method should be preceded by a
	 * call to <tt>{@link #setUp}</tt>.
	 */
	...
	/**
	 * Test the method <tt>setWord</tt> with a wrong old password. This method
	 * should be preceded by a call to <tt>{@link #setUp}</tt>.
	 */
	...
	/**
	 * Test the method <tt>setWord</tt> with an unacceptable new password. This
	 * method should be preceded by a call to <tt>{@link #setUp}</tt>.
	 */
	...
	/**
	 * Test the method <tt>setWord</tt> for correct usage. This method should be
	 * preceded by a call to <tt>{@link #setUp}</tt>.
	 */
	...
	/**
	 * Tests if the resulting value of a tested expression equals the expected
	 * (correct) value. This implementation prints both values, with an
	 * indication of what was tested, to the standard output. The implementation
	 * does not actually do the comparison.
	 */
